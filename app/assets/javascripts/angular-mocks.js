 ...
 * we don鈥檛 want to send {@link https://developer.mozilla.org/en/xmlhttprequest XHR} or
...
function createHttpBackendMock($rootScope, $delegate, $browser) {
   ...
   *   request is handled.
   *
   *  - respond 鈥� `{function([status,] data[, headers])|function(function(method, url, data, headers)}`
 ...
 *    an array containing response status (number), response data (string) and response headers
 *    (Object).
 *  - passThrough 鈥� `{function()}` 鈥� Any request matching a backend definition with `passThrough`
